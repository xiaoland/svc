...
- **Next Step**: Announce the exact external mutation gate for the user-scope collaboration section, dedicated GitHub App and identities, disposable real Issue, candidate worktree/branch, and free Quick Tunnel. The next verification is the real black-box Issue-to-Draft-PR campaign; local guards do not constitute product acceptance.
