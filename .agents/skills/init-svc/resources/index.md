...
5. Unit TDD Layer (30-unit-tdd/): logical structural design independent of physical folder movement
...
| Stuff | Fast | Local tactical code hazards and tripwires | Local AGENTS | <code-root>/**/AGENTS.md |
...
1. [Minimal Filesystem](filesystem.md)
2. [Typed Taxonomy and Mode Engine](meta-engine.md)
3. [Progressive Ontology](ontology.md)
4. [PRD](prd.md)
5. [Alignment Pack](alignment.md)
6. [Product TDD](product-tdd.md)
7. [Unit TDD and Local Context](unit-tdd.md)
8. [Deployment](deployment.md)
9. [Tasks](tasks.md)
10. [Promotion Rules](promotion-rules.md)
