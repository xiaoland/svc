...
v9.5 uses pacing layers to separate logical design from physical placement.
...
## 9.2 Local Context (<code-root>/**/AGENTS.md) -> Stuff
...
## 9.3 Reality Route Tripwire Rule
...
- [Local AGENTS Template](../assets/AGENTS.local.template.md)
- [Pacing Layers Map](./durable-destination-map.md)
