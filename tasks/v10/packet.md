...
- **Next Step**: Verify the corrected prepared-candidate environment in an isolated worktree, push it to `main`, then complete publication through the reviewed Release PR and protected environment.
