...
- Working protocol and mutation gate: `docs/00-meta/working-protocol.md`
- Non-trivial implementation judgment: `docs/00-meta/implementation-taste.md`
...
- Follow the working protocol's documentation-quality contract.
