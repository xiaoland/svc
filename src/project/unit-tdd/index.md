...
It should name scope, invariants, allowed write paths, hazards, recurrence signals, and required checks. It must not restate root policy or become a general architecture document. Use [the local template](../../templates/AGENTS.local.template.md).
