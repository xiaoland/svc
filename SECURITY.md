...
The canonical product boundaries remain in [Product Truth](src/sections/prd.md#local-trust-and-exposure-boundary),
[Product TDD](src/sections/product-tdd.md#authority-and-topology), and
[Deployment](src/sections/deployment.md#agent-evidence-runtime). In particular,
